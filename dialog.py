...
try:
    # Knihovna z materiálů předmětu (pokud je nainstalovaná).
    from event_emitter.events import EventEmitter
except ImportError:
    # Záložní, plně soběstačná implementace (viz _event_emitter.py),
    # aby aplikace běžela i bez balíčku z kurzu.
